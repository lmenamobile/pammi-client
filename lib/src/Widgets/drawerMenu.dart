...
class _DraweMenuPageState extends State<DraweMenuPage> {
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(height: 23),
                    itemMenu(context, "Assets/images/ic_start.png", () {
                      widget.rollOverActive != "start"
                          ? pushToPage(MyHomePage())
                          : Navigator.pop(context);
                    }, Strings.start),
                    itemMenu(context, "Assets/images/ic_ offers_day.png", () {
                      widget.rollOverActive != "ofertsDay"
                          ? pushToPage(DayOferstPage())
                          : Navigator.pop(context);
                    }, Strings.dayOferts),
                    itemMenu(context, "Assets/images/ic_featured.png", () {
                      widget.rollOverActive != "featured"
                          ? pushToPage(FeaturedPage())
                          : Navigator.pop(context);
                    }, Strings.destacados),
                    itemMenu(context, "Assets/images/ic_news.png", () {
                      widget.rollOverActive != "myOrders"
                          ? pushToPage(MyOrdersPage())
                          : Navigator.pop(context);
                    }, Strings.myOrders),
                    itemMenu(context, "Assets/images/ic_wishes.png", () {},
                        Strings.wishes),
                    itemMenu(context, "Assets/images/ic_ notification.png",
                        () {}, Strings.notifications),
                    itemMenu(context, "Assets/images/ic_support.png", () {
  ...
  Widget itemMenu(
      BuildContext context, String icon, Function action, String titleAction) {
    return GestureDetector(
      child: Container(
        width: double.infinity,
  ...
  pushToPage(Widget page) async {
    var data = await Navigator.of(context).pushReplacement(PageTransition(
        type: PageTransitionType.slideInLeft,
        child: page,
        duration: Duration(milliseconds: 700)));
