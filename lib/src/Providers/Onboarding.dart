...
class OnboardingProvider with ChangeNotifier {
  ...
  Future<dynamic> recoveryPassword(BuildContext context,String email) async {
    ...
    final response = await http.post(ConstantsApi.baseURL+"/onboarding/password-recovery",headers: header,body: body).timeout(Duration(seconds: 25))
        .catchError((value){
  ...
  Future<dynamic> verifyCode(BuildContext context,String email,String code) async {
    ...
    final response = await http.post(ConstantsApi.baseURL+"/onboarding/verify-code",headers: header,body: body).timeout(Duration(seconds: 25))
        .catchError((value){
  ...
  Future<dynamic> generateAccesToken(BuildContext context) async {
    ...
    final response = await http.get(ConstantsApi.baseURL+"wa/generate-access-token").timeout(Duration(seconds: 25))
        .catchError((value){
  ...
  Future<dynamic> createAccount(BuildContext context,UserModel userModel) async {
  ...
  Future<dynamic> getCountries(BuildContext context,String filter,int offset) async {
    ...
    final response = await http.post(ConstantsApi.baseURL+"location/get-countries",headers: header,body: body).timeout(Duration(seconds: 25))
        .catchError((value){
  ...
  Future<dynamic> getStates(BuildContext context,String filter,int offset,Country country) async {
    ...
    final response = await http.post(ConstantsApi.baseURL+"location/get-states",headers: header,body: body).timeout(Duration(seconds: 15))
        .catchError((value){
  ...
  Future<dynamic> getCities(BuildContext context,String filter,int offset,States state) async {
    ...
    final response = await http.post(ConstantsApi.baseURL+"location/get-cities",headers: header,body: body).timeout(Duration(seconds: 15))
        .catchError((value){
  ...
  Future<dynamic> verificationCode(BuildContext context,String code,String email) async {
    ...
    final response = await http.post(ConstantsApi.baseURL+"onboarding/verify-code",headers: header,body: body).timeout(Duration(seconds: 15))
        .catchError((value){
  ...
  Future<dynamic> sendAgainCode(BuildContext context,String email) async {
    ...
    final response = await http.post(ConstantsApi.baseURL+"onboarding/send-code-client",headers: header,body: body).timeout(Duration(seconds: 15))
        .catchError((value){
  ...
  Future<dynamic> updatePassword(BuildContext context,String password) async {
    ...
    final response = await http.post(ConstantsApi.baseURL+"onboarding/update-password",headers: header,body: body).timeout(Duration(seconds: 15))
        .catchError((value){
